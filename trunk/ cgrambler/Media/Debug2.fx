...
vertexOutput std_VS(appdata IN) {
   ...
   // OUT.WorldNormal = mul( float4(IN.Normal,1.0f) ,WorldITXf).xyz;
...
float4 std_PS(vertexOutput IN) : COLOR {
    ...
    float3 result = (diffuseColor*(diffContrib+AmbiColor));
    // return as float4
