...
typedef CDXUTTextPrinter*  CDXUTTextPrinterPtr;
...
typedef  D3D10_INPUT_ELEMENT_DESC*  D3D10_INPUT_ELEMENT_DESCPtr;
typedef D3DXVECTOR3* D3DXVECTOR3Ptr;
#endif
