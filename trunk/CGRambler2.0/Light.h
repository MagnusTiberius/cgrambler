...
public:
	Light(const WString &name,  D3DXVECTOR3 & pos,   D3DXVECTOR3  &lookAt,const D3DXVECTOR4 &specular,FLOAT falloffAngle,FLOAT falloffExponent,FLOAT fNear=1.0f,FLOAT fFar=100.0f);
