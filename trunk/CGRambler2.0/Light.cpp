...
Light::Light(const WString &name,  const D3DXVECTOR4 & Pos, const D3DXVECTOR4  &LookAt,const D3DXVECTOR4 &specular,FLOAT falloffAngle,FLOAT falloffExponent,FLOAT fNear,FLOAT fFar):Camera(Pos,LookAt,fNear,fFar)
{
